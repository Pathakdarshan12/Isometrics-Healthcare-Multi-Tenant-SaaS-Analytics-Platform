...
base_metrics as (
    select
        ...
        sum(case when is_30day_return and not is_readmission then 1 else 0 end) as returns_30day_non_readmit,
        ...
        -- Financial
        sum(case when is_readmission then total_charges else 0 end) as readmission_charges,
